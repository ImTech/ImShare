 ...
 * douzifly@gmail.com
 */
package com.imtech.imshare.widget;
 ...
 */
public class TextViewME extends View 
{
    public TextViewME(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public TextViewME(Context context) {
        this(context, null);
    } 
